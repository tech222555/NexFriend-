    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <p className="text-center text-xs text-gray-400 font-medium pt-4 leading-relaxed">
            By signing up, you agree to our <span className="text-gray-600 underline">Privacy Policy</span> and <span className="text-gray-600 underline">Terms of Service</span>.
          </p>
        </div>
